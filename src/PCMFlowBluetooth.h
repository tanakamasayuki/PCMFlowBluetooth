...
// (queue, decoder, PCMSource) is portable, and the adapter simply is not
// declared. See SPEC.md §13.1.
#if defined(ARDUINO_ARCH_ESP32) && defined(CONFIG_IDF_TARGET_ESP32)
#define PCMFLOWBLUETOOTH_HAS_ESPBLE_ADAPTER 1
#else
#define PCMFLOWBLUETOOTH_HAS_ESPBLE_ADAPTER 0
#endif
